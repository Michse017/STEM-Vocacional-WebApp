// Este archivo centraliza la configuración del cuestionario para mantener
// el componente Cuestionario.jsx más limpio y fácil de leer.
...
export const preguntasInteligencias = [
  { id: "pregunta_1", texto: "1.- Prefiero hacer un mapa que explicarle a alguien como tiene que llegar a un lugar determinado." },
  ...
  { id: "pregunta_6", texto: "6.- Puedo ayudar a un amigo(a) a manejar y controlar sus sentimientos, porque yo lo pude hacer antes en relación a sentimientos parecidos." },
  ...
  { id: "pregunta_14", texto: "14.- Siempre entiendo los gráficos que vienen en las instrucciones de equipos o instrumentos." },
  ...
  { id: "pregunta_17", texto: "17.- Me enojo cuando escucho una discusión o una afirmación que me parece ilógica o absurda." },
  ...
  { id: "pregunta_20", texto: "20.- A menudo puedo captar relaciones entre números con mayor rapidez y facilidad que algunos de mis compañeros." },
  ...
  { id: "pregunta_23", texto: "23.- Puedo mirar un objeto de una manera y con la misma facilidad verlo dado vuelta o al revés." },
  { id: "pregunta_24", texto: "24.- Con frecuencia establezco la relación que puede haber entre una música o canción y algo que haya ocurrido en mi vida." },
  { id: "pregunta_25", texto: "25.- Me gusta trabajar con números y figuras." },
  { id: "pregunta_26", texto: "26.- Me gusta sentarme muy callado y pensar, reflexionar sobre mis sentimientos más íntimos." },
  { id: "pregunta_27", texto: "27.- Solamente con mirar las formas de las construcciones y estructuras me siento a gusto." },
  { id: "pregunta_28", texto: "28.- Cuando estoy en la ducha, o cuando estoy solo me gusta tararear, cantar o silbar." },
  ...
  { id: "pregunta_32", texto: "32.- Muchas veces me doy cuenta de las expresiones o gestos en la cara de las otras personas." },
...
export const secciones = [
  {
    ...
    preguntas: [
      ...
      { id: "nivel_educativo_madre", texto: "Nivel educativo de la madre", tipo: "select", opciones: opcionesSociodemograficas.nivelEducativo },
      { id: "nivel_educativo_padre", texto: "Nivel educativo del padre", tipo: "select", opciones: opcionesSociodemograficas.nivelEducativo },
      { id: "ocupacion_padre", texto: "Ocupación principal del padre", tipo: "select", opciones: opcionesSociodemograficas.ocupacion },
      { id: "ocupacion_madre", texto: "Ocupación principal de la madre", tipo: "select", opciones: opcionesSociodemograficas.ocupacion },
      { id: "miembros_hogar", texto: "Número total de miembros en su hogar", tipo: "select", opciones: opcionesSociodemograficas.miembrosHogar },
      { id: "numero_hermanos", texto: "Número de hermanos/as", tipo: "select", opciones: opcionesSociodemograficas.numeroHermanos },
      { id: "condicion_discapacidad", texto: "¿Presenta alguna condición de discapacidad?", tipo: "select", opciones: opcionesSociodemograficas.condicionDiscapacidad },
      { id: "grupo_etnico", texto: "¿Se reconoce como perteneciente a algún grupo étnico?", tipo: "select", opciones: opcionesSociodemograficas.grupoEtnico },
      { id: "condicion_vulnerabilidad", texto: "¿Ha experimentado alguna de estas condiciones?", tipo: "select", opciones: opcionesSociodemograficas.condicionVulnerabilidad },
      { id: "trabaja_actualmente", texto: "¿Actualmente trabajas?", tipo: "select", opciones: opcionesSociodemograficas.trabajaActualmente },
      ...
      { id: "puntaje_competencias_ciudadanas", texto: "Puntaje Competencias Ciudadanas (0-100)", tipo: "number", min: 0, max: 100 },
      { id: "puntaje_ciencias_naturales", texto: "Puntaje Ciencias Naturales (0-100)", tipo: "number", min: 0, max: 100 },
    ]
  },
  {
