...
class RespSociodemografica(Base):
    ...
    miembros_hogar = Column(String(10))
    numero_hermanos = Column(String(10))
    ...
    puntaje_competencias_ciudadanas = Column(Integer, CheckConstraint('puntaje_competencias_ciudadanas BETWEEN 0 AND 100'))
...
class RespInteligenciasMultiples(Base):
    ...
    # Columnas para cada una de las 35 preguntas
